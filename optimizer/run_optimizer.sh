...
python optimizer_graph_hierarchical.py -f ../profiler/translation/profiles/gnmt_large/graph.txt -n 4 \
    --activation_compression_ratio 1 -o gnmt_large_repart 2>&1 >>  optimizer_graph_hierarchical.log
python convert_graph_to_model.py -f gnmt_large_repart/gpus=4.txt -n gnmt_large_repart \
    -a gnmt_large_repart -o ../runtime/translation/models/gnmt_large_repart/gpus=4 --stage_to_num_ranks 0:1,1:2,2:1 2>&1 >> convert_graph_to_model.log
