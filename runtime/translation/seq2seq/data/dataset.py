...
class TextDataset(Dataset):
    ...
    def get_loader(self, batch_size, world_size, rank, seeds=None, shuffle=False, num_workers=0,
        ...
        if shuffle:
            sampler = BucketingSampler(self, batch_size=batch_size, seeds=seeds,
                                       bucketing=bucketing, world_size=world_size,
                                       rank=rank)
        else:
            sampler = StaticDistributedSampler(self, batch_size=batch_size, pad=pad,
